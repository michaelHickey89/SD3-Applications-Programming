...
public class Ex1 {
    ...
    private static int determineSmallest(int[] rands) {
    ...
    private static int determineLargest(int[] rands) {
        int largest = rands[0];
    ...
    private static int sevenCount(int[] rands) {
        int sevenCount = 0;
    ...
    private static int calculateSum(int[] rands) {
        int sum = 0;
        for (int i = 0; i < rands.length; i++) {
            sum += rands[i];
        }
    ...
    private static double calculateAvg(int[] rands) {
        int sum = 0;
